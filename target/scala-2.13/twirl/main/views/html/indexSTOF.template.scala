            ...
            """),_display_(/*22.14*/for(post <- posts) yield /*22.32*/ {_display_(Seq[Any](format.raw/*22.34*/("""
                """),format.raw/*23.17*/("""<dl class="dl-horizontal" >
                    ...
                    """),_display_(/*44.22*/if(session.get(models.Global.SESSION_USERNAME_KEY).nonEmpty)/*44.82*/ {_display_(Seq[Any](format.raw/*44.84*/("""
                            ...
                            """),format.raw/*46.29*/("""<button><a href=""""),_display_(/*46.47*/routes/*46.53*/.ContentController.upvote(post.id)),format.raw/*46.87*/("""  """),format.raw/*46.89*/(""""> upvote </a></button>
                            <button><a href=""""),_display_(/*47.47*/routes/*47.53*/.ContentController.downvote(post.id)),format.raw/*47.89*/(""""> downvote </a></button>

                    """)))}),format.raw/*49.22*/("""
                    """),format.raw/*50.21*/("""<button><a href=""""),_display_(/*50.39*/routes/*50.45*/.ContentController.postWithAnswers(post.id)),format.raw/*50.88*/("""">Expand</a> </button>
                    </ul>
                </dl>
            """)))}),format.raw/*53.14*/("""
            """),format.raw/*54.13*/("""</dl>
